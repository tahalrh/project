...
class Game:
    ...
    def handle_events(self):
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                elif event.key == pygame.K_q and (self.game_state == "game_over" or self.game_state == "victory"):
    ...
    def update(self, dt):
        ...
        if self.game_state == "playing":
            ...
            if self.player.current_hearts <= 0 or self.player.health <= 0:
                print("Le joueur est mort ! Affichage de l'écran game over.")
